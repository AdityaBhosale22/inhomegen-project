...
def generate(request):
    if request.method == 'POST':
        ...
        path = convert_image_to_svg(prompt, negative_prompt, img_id=next_id, 
...
def convert_image_to_svg(input_prompt, negative_prompt, img_id, style_templateslist_id=0, look_id=0, styles_id=0, artists_id=0, color_palette_id=0, artistic_params_id=0):
